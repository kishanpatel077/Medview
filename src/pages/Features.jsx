...
export default function Features() {
  return (
    <PageTransition className="bg-white dark:bg-background">
      <section className="mx-auto w-full max-w-[1600px] px-4 py-16 sm:px-6 xl:px-8">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">Features</p>
          <h1 className="mt-3 text-4xl font-bold tracking-normal text-slate-950 dark:text-white sm:text-5xl">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {features.map(([title, text, Icon], index) => (
            <motion.article
              ...
              className="rounded-lg border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-card"
