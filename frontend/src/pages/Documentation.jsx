...
export default function Documentation() {
  return (
    <PageTransition className="bg-slate-50 dark:bg-background">
      <section className="mx-auto w-full max-w-[1500px] px-4 py-10 sm:px-6 sm:py-16 xl:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold text-slate-950 dark:text-white sm:text-4xl xl:text-5xl">
              MedView upload and viewer guide
            </h1>
          ...
          <div className="grid gap-4">
            {sections.map((section) => {
              ...
              return (
                <article
                  className="rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-card sm:p-5"
                  key={section.title}
                >
                  <div className="mb-4 flex items-center gap-3">
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-md bg-blue-500/10 text-primary">
                      <Icon />
                    </div>
                    <h2 className="text-lg font-semibold text-slate-950 dark:text-white sm:text-xl">{section.title}</h2>
                  </div>
